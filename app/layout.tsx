...
export const metadata: Metadata = {
  title: 'شركة حصن المملكة الوطنية لمكافحة الحشرات والوقاية الإنشائية | معتمدة رسمياً SFDA وبلدي',
  description: 'المؤسسة الوطنية الرائدة في مكافحة الآفات والحشرات، حقن وتدفين النمل الأبيض (الأرضة) بضمان 15 سنة، إبادة الصراصير وبق الفراش والقوارض وطرد الحمام بمبيدات معتمدة من هيئة الغذاء والدواء SFDA ومنصة بلدي. خدمة 24 ساعة بكافة مدن المملكة. اتصل: 0558141870.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'معتمدون لدى هيئة الغذاء والدواء SFDA ومنصة بلدي. حلول هندسية متكاملة لإبادة الآفات مع ضمانات موثقة تصل إلى 15 عاماً وسرعة وصول في 25 دقيقة بكافة مناطق المملكة.',
    type: 'website',
    locale: 'ar_SA',
  },
  twitter: {
