          ...
          {SAUDI_BLOG_POSTS.map((post) => (
            ...
            >
              ...
              <div className="p-5 pt-0 flex gap-2">
                <Link
                  href={`/blog/${post.slug}`}
                  className="flex-1 py-2.5 px-3 bg-emerald-50 hover:bg-emerald-100 text-emerald-900 font-bold text-xs rounded-xl transition flex items-center justify-center gap-1 border border-emerald-300"
                >
                ...
                <button
                  ...
                  className="py-2.5 px-3 bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold text-xs rounded-xl transition border border-slate-200 cursor-pointer"
                  title="قراءة سريعة"
                >
                  معاينة
                </button>
