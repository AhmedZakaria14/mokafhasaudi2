...
const FAQS_DATA: FaqItem[] = [
  ...
  },
  {
    ...
    a: 'نعم، مؤسستنا مرخصة ومصنفة رسمياً ومطابقة لاشتراطات وزارة البلديات والإسكان، وتصدر شهادات معالجة إلكترونية وسجلات تفتيش رقمية مطابقة لمعايير الهاسب HACCP وISO لتجديد الرخص للمطاعم والمستودعات والشركات.'
  },
  {
    category: 'طرق الدفع',
